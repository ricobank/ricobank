...
describe('Vox', () => {
  ...
  before(async () => {
    ...
    await send(bank.filhi, b32('weth'), b32('ftag'), b32('weth'), b32('weth:ref'))
  ...
  describe('gas', () => {
    ...
    it('deploy gas', async () => {
      await check(ethers.BigNumber.from(deploygas), 43313808)
    })
