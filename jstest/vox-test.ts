...
describe('Vox', () => {
  ...
  describe('gas', () => {
    ...
    it('deploy gas', async () => {
      await check(ethers.BigNumber.from(deploygas), 41233878)
    })
