...
describe('Gas', () => {
  ...
  describe('gas', () => {
    ...
    it('deploy gas', async () => {
      await check(ethers.BigNumber.from(deploygas), 13871263)
    })
